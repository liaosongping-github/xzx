...
export function ProductInformationPage({ schema, registry }: Props) {
  ...
  const tableColumns = isComboTab ? [...visibleColumns.filter((column) => column !== "操作" && !comboCategoryColumns.includes(column)), ...comboCategoryColumns, "操作"] : visibleColumns;
